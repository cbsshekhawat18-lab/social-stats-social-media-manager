...
// ── Styles ────────────────────────────────────────────────────────────────────
const pageWrap = { minHeight: '100vh', background: '#f0f4f9', fontFamily: 'inherit' };
...
const printBtn = {
  padding: '8px 18px', background: '#00d7ff', color: '#0f172a',
...
const kpiCard = {
  ...
  background: '#f0f4f9', borderRadius: 10, padding: '12px 14px',
...
const thStyle    = { textAlign: 'left', padding: '8px 12px', background: '#f0f4f9', color: '#64748b', fontWeight: 700, fontSize: 11, textTransform: 'uppercase', borderBottom: '1px solid #e5e7eb' };
const trStyle    = { borderBottom: '1px solid #f1f5f9' };
const tdStyle    = { padding: '10px 12px', color: '#374151' };

const postRow   = { display: 'flex', gap: 14, alignItems: 'flex-start', background: '#f0f4f9', borderRadius: 10, padding: 14, border: '1px solid #e5e7eb' };
