# Fix Terms & Privacy: clarify that Social Stats reads analytics from social platforms
                ...
                'sections': [
                    {
                        ...
                        'html': (
                            '<p>Social Stats ("we", "our", or "us") operates a social media analytics and content-planning '
                            'platform at <strong>socialstats.app</strong>. We connect to Facebook, Instagram, Google, YouTube, '
                            ...
                            'the rights available to you. By using Social Stats you agree to this Privacy Policy. If you do not agree, '
                    ...
                    },
                    {
                        ...
                        'html': (
                            ...
                            '<li><strong>User-created content</strong> — calendar posts, notes, AI-generated captions, and post ideas you create within Social Stats for your own planning purposes</li>'
                            '</ul>'
                    ...
                    },
                    {
                        ...
                        'html': (
                            ...
                            'contact us immediately at <a href="mailto:support@socialstats.app">support@socialstats.app</a>.</p>'
                        ),
                    },
                    {
                    ...
                    },
                    {
                        ...
                        'html': (
                            ...
                            '<p>'
                            '<strong>Email:</strong> <a href="mailto:support@socialstats.app">support@socialstats.app</a><br />'
                            '<strong>Website:</strong> <a href="https://socialstats.app" target="_blank" rel="noreferrer">socialstats.app</a>'
                            '</p>'
                        ),
                    },
                ],
            ...
            'content': {
                ...
                'sections': [
                    ...
                    },
                    {
                        ...
                        'html': (
                            '<p>Social Stats is a social media analytics and content-planning platform that connects to your '
                            ...
                            'your social media posts within Social Stats</li>'
                            ...
                            '</ul>'
                            '<p><strong>How we interact with your social accounts:</strong> Social Stats retrieves analytics data '
                            ...
                            'in the Social Stats content calendar (drafts, scheduled posts, captions) is stored within Social Stats only and '
                    ...
                    },
                    {
                        ...
                        'html': (
                            ...
                            'official API under your explicit OAuth consent. Social Stats requests <strong>read-only permissions</strong> '
