...
const s = {
  ...
  loading: { color: '#94a3b8', fontSize: 13, padding: '12px 0' },
  grid: {
    display: 'grid',
  ...
  bizName: { fontWeight: 700, fontSize: 15, color: '#0f172a' },
  ...
  detailIcon: { color: '#64748b', flexShrink: 0, marginTop: 1 },
  ...
  ownerReply: {
    ...
    background: '#f8fafc', borderLeft: '3px solid #4285f4',
    fontSize: 12, color: '#475569', lineHeight: 1.5, borderRadius: '0 6px 6px 0',
  },
};
