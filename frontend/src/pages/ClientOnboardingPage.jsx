...
const styles = {
  ...
  heroMeterValue: { fontSize: 22, fontWeight: 900, color: '#0f172a' },
  ...
  contentTitle: { marginTop: 2, fontSize: 18, fontWeight: 800, color: '#0f172a' },
  contentStepBadge: {
    padding: '8px 12px',
    borderRadius: 999,
    background: '#f1f5f9',
  ...
  stepText: { marginLeft: 8, flex: 1, minWidth: 0 },
  stepMicro: { fontSize: 10, fontWeight: 800, color: '#94a3b8', textTransform: 'uppercase', letterSpacing: '.08em', marginBottom: 2, display: 'none' },
  stepTitle: { fontSize: 13, fontWeight: 700, color: '#0f172a', whiteSpace: 'nowrap' },
  stepDesc: { fontSize: 11, color: '#64748b', marginTop: 1, display: 'none' },
  stepLine: {
    position: 'absolute',
    top: 17,
    left: 36,
  ...
  featureText: { fontSize: 12, color: '#64748b', lineHeight: 1.5 },
  panelGrid: {
    display: 'grid',
    gap: 18,
  },
  ...
  connectMiniValue: { fontSize: 26, fontWeight: 900, color: '#0f172a' },
